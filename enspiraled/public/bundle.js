    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.circles.map(function (circle, i) {
          return _react2.default.createElement(_Circle2.default, { key: 'circle' + i, cx: circle.cx, cy: circle.cy, r: circle.r, h: _this2.handleClick, level: circle.level });
        })
      );
    }
  }]);
...
var Circle = function (_React$Component) {
    ...
    _createClass(Circle, [{
        ...
        value: function handleMouseOver() {
            if (!this.state.circles.length) this.setState({
                circles: [_defineProperty({
                    cx: this.props.cx - this.props.r,
                    cy: this.props.cy,
                    level: this.props.level + 1,
                    r: this.props.r / 2
                }, 'level', 1), _defineProperty({
                    cx: this.props.cx + this.props.r,
                    cy: this.props.cy,
                    level: this.props.level + 1,
                    r: this.props.r / 2
                }, 'level', 2), _defineProperty({
                    cx: this.props.cx,
                    cy: this.props.cy - this.props.r,
                    level: this.props.level + 1,
                    r: this.props.r / 2
                }, 'level', 3), _defineProperty({
                    cx: this.props.cx,
                    cy: this.props.cy + this.props.r,
                    level: this.props.level + 1,
                    r: this.props.r / 2
        ...
        value: function render() {
            ...
            var color = (0, _color.getColor)(rand);
            return _react2.default.createElement(
                'g',
                null,
                _react2.default.createElement('circle', { fill: color, cx: this.props.cx, cy: this.props.cy, r: this.props.r,
                    onMouseOver: this.handleMouseOver }),
                this.state.circles.map(function (circle, i) {
                    return _react2.default.createElement(Circle, { key: 'circle' + i, cx: circle.cx, cy: circle.cy, r: circle.r, fill: color });
                })
            );
        }
    }]);
