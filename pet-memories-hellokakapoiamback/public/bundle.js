...
var Board = function (_React$Component) {
  ...
  function Board(props) {
    ...
    _this.getBoardWithCellVisibility = _this.getBoardWithCellVisibility.bind(_this);
    _this.checkContents = _this.checkContents.bind(_this);
    return _this;
  }
  ...
  _createClass(Board, [{
    ...
    key: 'checkContents',
    value: function checkContents(cell) {
      ...
      console.log(cell);
      return [].concat(_toConsumableArray(this.state.visibilityCount), [cell]);
    }
  }, {
    key: 'getBoardWithCellVisibility',
    value: function getBoardWithCellVisibility(board, cell, value) {
        ...
        board.map(function (row, rid) {
          ...
          return _react2.default.createElement(
            ...
            row.map(function (cell) {
              ...
              return _react2.default.createElement(_Cell2.default, { key: cell.id, cell: cell, checkPairs: _this2.checkPairs });
            })
          );
        })
      );
